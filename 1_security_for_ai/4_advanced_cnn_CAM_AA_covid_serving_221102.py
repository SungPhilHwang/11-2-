...
## 학습된 모델파일 경로에 위치시키자
# output_covid 폴더 안에 best_model.pt 파일이 있어야 함

##실행
# streamlit run 4_advanced_cnn_CAM_AA_covid_serving_221102.py
...
if uploaded_file:
    ...
    st.header('Covid19 판독 결과: %s'%(result[0]))
